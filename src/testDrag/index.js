...
import { mutliDragAwareReorder, multiSelectTo as multiSelect } from "./utils.js";
import "./style.css";
            ...
            {/* {entities.columnIds.map((id) => ( */}
              {/* // <Col key={id} xs={12}> */}
                {/* <div className="inner-col"> */}
                  ...
                  <Table
                    dataSource={getTasks(entities, 'todo')}
                    columns={tableColumns}
                    rowKey="id"
                    // pagination={{
                    //   pageSize,
                    //   total: entitiesMock.columns['todo'].taskIds.length,
